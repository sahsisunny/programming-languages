...
def getVals():
    ...
    print("Emergency Contact: ", emergencyValue.get())
    print("Payment Mode: ", pymentmodeValue.get())
    print("Food Service: ", foodserviceValue.get())
    with open("records.txt", "a") as f:
        f.write(
            f"{nameValue.get(), phoneValue.get(), genderValue.get(), emergencyValue.get(), pymentmodeValue.get(), foodserviceValue.get()}\n")


root = Tk()
root.geometry("400x250")
root.title("Travel Form 2.0")
