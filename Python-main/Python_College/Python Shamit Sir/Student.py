...
db_cursor = db_connection.cursor(
    buffered=True)  # "buffered=True".makes db_cursor.row_count return actual number of records selected otherwise would return -1
...
class StudentApp(tk.Tk):
    def __init__(self):
        ...
        self.lblTitle = tk.Label(self, text="Student Management System", font=("Helvetica", 16), bg="yellow",
                                 fg="green")
...
db_cursor.execute(
    "create table if not exists Student_master(Id INT(10) NOT NULL PRIMARY KEY AUTO_INCREMENT,rollno INT(15),fname VARCHAR(30),lname VARCHAR(30),city VARCHAR(20),state VARCHAR(30),mobileno VARCHAR(10),dob date)AUTO_INCREMENT=1")
db_connection.commit()
